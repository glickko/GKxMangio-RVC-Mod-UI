...
if __name__ == "__main__":
    ...
    class GUIConfig:
        def __init__(self) -> None:
            ...
            # OLD self.timbre is now mid_timbre_target
    ...
    class GUI:
        ...
        def launcher(self):
            ...
            self.realtime_param_keys = [
                "threhold", "pitch", "index_rate", "input_volume", "input_formant_shift", "input_timbre", "output_volume", "I_noise_reduce", "O_noise_reduce", "formant_shift", "bypass_vc",
            ...
            dynamic_timbre_settings_layout = [
                ...
                [sg.Text("Mid/High Crossover (Hz)"), sg.Slider(range=(200, 800), key="high_pitch_crossover", resolution=1, orientation="h", default_value=data.get("high_pitch_crossover", 400.0), expand_x=True, enable_events=True)],
                [sg.HSep()],
                ...
                [sg.Frame("Mid Pitch Band", [
                    [sg.Text("Target Timbre"), sg.Slider(range=(0.0, 2.0), key="mid_timbre_target", resolution=0.01, orientation="h", default_value=data.get("mid_timbre_target", 1.0), expand_x=True, enable_events=True)],
                ], expand_x=True)],
            ...
            formant_timbre_frame = sg.Frame("Global Formant", [
            ...
            effects_col_layout = [
                ...
                [dynamic_timbre_frame], # New location for dynamic timbre
                [dynamic_proximity_frame], 
                [low_freq_dampening_frame], 
                [saturation_frame], 
                [discord_effects_frame], 
