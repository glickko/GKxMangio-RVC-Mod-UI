    ...
    class GUI:
        ...
        def launcher(self):
            ...
            performance_settings_layout = [
                ...
                [sg.Text("Hop Length"), sg.Slider(range=(32, 4096), key="hop_length", resolution=32, orientation="h", default_value=data.get("hop_length", 128), expand_x=True)],
        ...
        def set_values(self, values):
            ...
            self.config.is_half, self.config.hop_length = values["fp16"], int(values["hop_length"])
